    ...
    <div className="size-full bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <div className="fixed top-4 left-4 z-50">
        <Button
          onClick={handleBackToMenu}
          size="sm"
          className="bg-gradient-to-r from-gray-100 to-gray-200 hover:from-gray-200 hover:to-gray-300 text-gray-900 shadow-lg rounded-xl font-bold border-2 border-gray-300"
        >
