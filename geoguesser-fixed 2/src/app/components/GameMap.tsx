  ...
  return (
    <div className="relative h-full w-full rounded-xl overflow-hidden shadow-2xl border-4 border-gray-300">
      ...
      {!disabled && !guessLocation && (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#C8102E] to-red-600 text-white px-6 py-3 rounded-xl shadow-xl text-sm font-bold z-[1000] pointer-events-none border-2 border-white">
          🌍 Klik på kortet for at gætte
        </div>
      )}
