import { Globe, Brain, Zap, Trophy, Play } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pb-20">
      ...
      <div className="bg-white shadow-sm">
        <div className="px-6 py-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Politiken Spil</h1>
          <p className="text-gray-600">
            Test din viden og konkurrér med andre læsere
          </p>
        </div>
      </div>
